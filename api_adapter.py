...
# ============================================================================
# ОБЩИЙ КЛАСС ОШИБОК (совместим с обоими бэкендами)
# ============================================================================

class SheetsAPIError(Exception):
    """
    Класс ошибок API - используется для совместимости с legacy кодом.
    Работает как с Google Sheets, так и с Supabase.
    """
    pass
...
__all__ = ["get_sheets_api", "SheetsAPI", "SheetsAPIError", "USE_BACKEND", "get_break_manager", "reset_break_manager"]
